...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    let url = `https://kitsu.io/api/edge/trending/manga?page`;
        ...
        if (attr.titles.en === undefined) {
            teks += `
                        ...
                        <div class="inside-card">
                            ...
                            <div class="box">
                                <a href="" class="name">${attr.titles.en_us}</a>
...
document.addEventListener("DOMContentLoaded", async () => {
    let screenWidth = window.innerWidth;
    let limit = screenWidth > 700 ? 8 : 4;
    let url = `https://kitsu.io/api/edge/manga?filter[categories]=comedy&page[limit]=${limit}`;
        ...
        if (attr.titles.en === undefined) {
            teks += `
                        ...
                        <div class="inside-card">
                            ...
                            <div class="box">
                                <a href="" class="name">${attr.titles.en_us}</a>
                                <a class="rank">Populatiry Rank : <span class="rank-value">${attr.popularityRank}</span></a><br />
...
more.addEventListener('click', async () => {
    ...
    let url1 = `https://kitsu.io/api/edge/manga?sort=-averageRating&page[limit]=20`;
    let url2 = `https://kitsu.io/api/edge/manga?sort=-averageRating&page[limit]=20&page[offset]=20`;
    let url3 = `https://kitsu.io/api/edge/manga?sort=-averageRating&page[limit]=20&page[offset]=40`;
...
more2.addEventListener('click', async () => {
    ...
    let url1 = `https://kitsu.io/api/edge/manga?filter[status]=upcoming&page[limit]=20`;
    let url2 = `https://kitsu.io/api/edge/manga?filter[status]=upcoming&page[limit]=20&page[offset]=20`;
    let url3 = `https://kitsu.io/api/edge/manga?filter[status]=upcoming&page[limit]=20&page[offset]=40`;
...
more3.addEventListener('click', async () => {
    ...
    let url1 = `https://kitsu.io/api/edge/filter[categories]=comedy&page[limit]=20`;
    let url2 = `https://kitsu.io/api/edge/filter[categories]=comedy&page[limit]=20[offset]=20`;
    let url3 = `https://kitsu.io/api/edge/filter[categories]=comedy&page[limit]=20[offset]=40`;
...
const containerAwal = document.querySelector(".containerAwal")
